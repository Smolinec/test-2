...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, cz.jirka.test.domain.Temperature.class.getName() + ".values");
            createCache(cm, cz.jirka.test.domain.Values.class.getName());
            createCache(cm, cz.jirka.test.domain.Values.class.getName() + ".temperatures");
