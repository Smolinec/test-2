...
import static cz.jirka.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cz.jirka.test.TestMemoryH2App;
import cz.jirka.test.config.Constants;
import cz.jirka.test.domain.User;
import cz.jirka.test.repository.AuthorityRepository;
import cz.jirka.test.repository.UserRepository;
import cz.jirka.test.security.AuthoritiesConstants;
import cz.jirka.test.service.UserService;
import cz.jirka.test.service.dto.PasswordChangeDTO;
import cz.jirka.test.service.dto.UserDTO;
import cz.jirka.test.web.rest.vm.KeyAndPasswordVM;
import cz.jirka.test.web.rest.vm.ManagedUserVM;
