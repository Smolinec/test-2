...
import static cz.jirka.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

import cz.jirka.test.TestMemoryH2App;
import cz.jirka.test.config.Constants;
import cz.jirka.test.config.audit.AuditEventConverter;
import cz.jirka.test.domain.PersistentAuditEvent;
